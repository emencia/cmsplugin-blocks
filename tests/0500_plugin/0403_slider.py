...
class SliderCMSPluginsTestCase(FixturesTestCaseMixin, CMSPluginTestCase):
    ...
    def test_form_view_add(self):
        ...
        item_features_field = dom.find("select#id_slide_item-__prefix__-features")
        assert len(item_features_field) == 1
    ...
    @override_settings(BLOCKS_SLIDER_FEATURES=[], BLOCKS_SLIDERITEM_FEATURES=[])
    def test_form_view_empty_features(self):
        ...
        item_features_field = dom.find("select#id_slide_item-__prefix__-features")
        assert len(item_features_field) == 0
    ...
    def test_form_view_edit(self):
        ...
        item_features_field = dom.find("select#id_slide_item-0-features")
        assert len(item_features_field) == 1
        ...
        item_features_field = dom.find("select#id_slide_item-1-features")
        assert len(item_features_field) == 0

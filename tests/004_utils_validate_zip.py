...
def test_validate_zip_not_a_zip(testsettings, filename):
    """
...
def test_validate_zip_invalid(testsettings):
    """
...
def test_validate_zip(testsettings, filename):
    """
...
def test_valid_zip_basic_to_object(testsettings):
    """

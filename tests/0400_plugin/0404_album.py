...
class AlbumCMSPluginsTestCase(FixturesTestCaseMixin, CMSPluginTestCase):
    ...
    def test_form_view_add(self):
        ...
        item_features_field = dom.find("select#id_album_item-__prefix__-features")
    ...
    @override_settings(BLOCKS_ALBUM_FEATURES=[], BLOCKS_ALBUMITEM_FEATURES=[])
    ...
    def test_form_view_edit(self):
        ...
        item_features_field = dom.find("select#id_album_item-0-features")
        assert len(item_features_field) == 1
        ...
        item_features_field = dom.find("select#id_album_item-1-features")
        assert len(item_features_field) == 0

...
help:
	...
	@echo
	@echo "  install             -- to install as develop package with every for development"
	@echo
...
clean: delpyc
	rm -Rf venv dist .tox *.egg-info .cache project_test/.cache/ project_test/__pycache__/ project_test/tests/__pycache__/
...
flake:
	$(FLAKE) --show-source cmsplugin_blocks
